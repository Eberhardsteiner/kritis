      ...
      <section className="card">
        <div className="section-heading">
          ...
          <div className="chip-row">
            <span className="chip success">7 Sprints abgeschlossen</span>
            <span className="chip success">Sprint I umgesetzt</span>
            <span className="chip outline">Produktstand 1.1</span>
          </div>
        </div>
