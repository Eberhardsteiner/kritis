      ...
      <section className="hero card">
        <div>
          ...
          <p className="hero-text">
            Phase 4 bündelt Rollenmodell, Nutzerprofile, regulatorische Fristen und die
            Dokumentenbibliothek in einem eigenen Steuerungsbereich. Damit wird die App
            näher an einen realen operativen Arbeitsmodus geführt.
          </p>
        ...
        <div className="hero-actions">
          ...
          <div className="inline-note">
            <ShieldCheck size={16} />
            <span>
              {activeUser ? `${activeUser.name || 'Nutzer'} arbeitet im Profil ${activeAccessProfile.label}.` : 'Nutzerprofil auswählen'}
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="content-grid two-column">
        <article className="card">
          <div className="section-heading">
            <div>
              ...
              <h3>Regulatorische Basisdaten und Meldekontakte</h3>
            </div>
            <div className="inline-note">
              <BellRing size={16} />
        ...
        <article className="card">
          ...
          <div className="mini-list top-gap">
            ...
            <div className="mini-list-row"><span>Lokale Anhänge</span><strong>{documentLibrarySummary.attachedFiles}</strong></div>
