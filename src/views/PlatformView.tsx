    ...
    <div className="view-stack">
      <section className="hero card">
        <div>
          ...
          <h2>Lesemodus ohne Login, geschützte Bearbeitung und versionierte Dokumente</h2>
          <p className="hero-text">
            Die Plattformsicht bündelt den offenen Lesemodus, geschützte Bearbeitung nach Anmeldung,
            Mandantenrichtlinien, Exportregister und Dokumentversionierung. Sprint I härtet
            den Sicherheitsrahmen zusätzlich durch Rollenprüfung, geschützte Downloads und eine
            sauberere Trennung zwischen Demo- und Produktivmodus.
          </p>
          ...
          {!authSession ? (
            <div className="form-grid two-column top-gap">
              ...
              <div className="feedback-box success wide top-gap">
                ...
                <p className="top-gap">
                  Demo-Konto: <code>admin@krisenfest.local</code>. Das Passwort wird bewusst nicht mehr über die Oberfläche oder den Bootstrap-Endpunkt offengelegt.
                </p>
              </div>
            </div>
          ) : (
