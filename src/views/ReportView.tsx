import { Download, FileSpreadsheet, FileText, Printer, ScrollText } from 'lucide-react';
import type {
  ActionItem,
  AuditFindingSummary,
  BenchmarkSnapshot,
    ...
    <div className="view-stack printable-report">
      <section className="card compact no-print">
        ...
        <p>
          ...
          Fristensteuerung und Zertifizierungssteuerung in einer druckbaren Managementsicht.
        </p>
