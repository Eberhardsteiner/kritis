import { FileText, LibraryBig, ListTodo, PlusCircle, Sparkles } from 'lucide-react';
...
export function MeasuresView({
  ...
  const localAttachments = evidenceItems.filter((item) => item.attachment).length;
    ...
    <div className="view-stack">
      <section className="card compact">
        ...
        <div className="summary-strip top-gap">
          ...
          <span>{localAttachments} lokale Anhänge</span>
        </div>
      </section>
          ...
          {evidenceItems.length ? (
            ...
            <div className="empty-state panel-empty">
              ...
              <div>
                ...
                <p>
                  Ergänzen Sie Dokumentreferenzen, Testprotokolle, Übungsberichte, Versionen,
                  Reviewer und bei Bedarf kleine lokale Anhänge.
                </p>
              </div>
            </div>
          )}
