    ...
    <div className="view-stack">
      <section className="content-grid two-column">
        <article className="card">
          ...
          <p>
            Phase 3 erweitert die Module um Benchmark-Zielprofile, Rollenvorlagen und
            Audit-Checklist-Einträge. So lassen sich branchenspezifische Anforderungen ohne
            Codeänderung in die Grundlogik einspielen.
          </p>
        ...
        <article className="card">
          ...
          <div className="schema-grid top-gap">
            ...
            <div>
              ...
              <p className="muted small">Maßnahmen- und Nachweisvorlagen</p>
            </div>
            <div>
