  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer card">
        ...
        <strong>Backend, Dateispeicher und serverseitige Rechteprüfung</strong>
        <p>
          Phase 5 ergänzt den Monitor um API-Synchronisierung, Snapshots, Audit-Log
          und eine prototypische serverseitige Dokumentenablage.
        </p>
      </div>
    </aside>
  );
