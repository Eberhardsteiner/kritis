  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer card">
        ...
        <strong>Mandanten, Anmeldung und revisionsfähige Dokumentenhistorie</strong>
        <p>
          Phase 6 ergänzt den Monitor um Serveranmeldung, Mandantentrennung, Zugriffskonten
          und eine versionierte Dokumentenablage mit Checksummen.
        </p>
      </div>
    </aside>
  );
